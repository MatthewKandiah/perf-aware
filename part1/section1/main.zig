...
pub fn main() !void {
    ...
    // const output_file = try std.fs.createFileAbsolute("/home/matt/code/perf-aware/part1/section1/single_register_mov_out.asm", .{});
    const output_file = try std.fs.createFileAbsolute("/home/matt/code/perf-aware/part1/section1/many_register_mov_out.asm", .{});
